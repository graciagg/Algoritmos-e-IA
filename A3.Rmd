...
Todos los métodos de aprendizaje supervisado nos han proporcionado muy buenos valores respecto a la sensibilidad, especificidad y exactitud, medidas a través de las matrices de confusión proporcionada por cada método. Metodos como el k-NN, LDA y RDA son los que mejores datos nos proporcionan. Estos buenos resultados también se ven reflejados en los F-score obtenidos.
