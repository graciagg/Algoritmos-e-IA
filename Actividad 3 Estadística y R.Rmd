...
Tenemos que transformar la variable 'Extension' en binomial (si y no). Es decir, en caso de que haya metástatisis será 'si' y de ser regional o localizado será 'no'. Para el primer ejemplo, hemos cogido las variables sexo y edad, junto a los dos primeros componentes principales dividios en terciles. 
...
for (i in 1:2) {  # Tomamos los 3 primeros componentes como ejemplo
  pca_df[[paste0("PC", i, "_tercile")]] <- cut(pca_df[[paste0("PC", i)]], 
...
modelo_regresion <- glm(extension ~ PC1_tercile + PC2_tercile + edad + sexo, data = datos_modelo, family = binomial)
